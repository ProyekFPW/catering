    ...
    <form action="post_register" method="post">
        ...
        @php
            ...
            {
                if($select == -1){
                    echo "<option selected='selected' value='{{$prov[`id_provinsi`]}}' name='prov'>".$prov["nama_provinsi"]."</option>";
                    $select = 0;
                }else{
                    echo "<option value='{{$prov[`id_provinsi`]}}' name='prov'>".$prov["nama_provinsi"]."</option>";
                }
            }
        @endphp
        ...
        <select class="form-control select2" id='kota' style="width: 100%;">
            ...
            foreach($dataKota as $prov)
            {
                if($select == -1){
                    echo "<option selected='selected' value='{{$prov[`id_kota`]}}' name='prov'>".$prov["nama_kota"]."</option>";
                    $select = 0;
                }else{
                    echo "<option value='{{$prov[`id_kota`]}}' name='prov'>".$prov["nama_kota"]."</option>";
                }
            }
        @endphp
        </select>
        ...
        <input type="submit" value="Ke Login" name="btnlogin" class='btn btn-block bg-gradient-secondary btn-lg'>
